...
\usepackage{xspace} % Smart spacing after commands in text mode
...
% Use \ensuremath so these commands work in both text and math mode.
\newcommand{\Y}{\ensuremath{Y}\xspace}
\newcommand{\sig}{\ensuremath{\sigma}\xspace}
\newcommand{\p}{\ensuremath{p}\xspace}
\newcommand{\vff}{\ensuremath{\log(\Phi)}\xspace}
\newcommand{\inc}{\ensuremath{i}\xspace}
\newcommand{\soft}{\ensuremath{s}\xspace}
\newcommand{\Ypol}{\ensuremath{Y_{\text{pol}}}\xspace}
\newcommand{\sigpol}{\ensuremath{\sigma_{\text{pol}}}\xspace}
\newcommand{\ppol}{\ensuremath{p_{\text{pol}}}\xspace}
\newcommand{\vffpol}{\ensuremath{\log(\Phi_{\text{pol}})}\xspace}
\newcommand{\open}{\ensuremath{\mathcal{O}_{\text{mid}}}\xspace}
\newcommand{\clfrac}{\ensuremath{f_{\text{cl}}}\xspace}
\newcommand{\Nlos}{\ensuremath{N_{\text{los}}}\xspace}
\newcommand{\Acl}{\ensuremath{A_{\text{cl}}}\xspace}
\newcommand{\Nlospol}{\ensuremath{N_{\text{los,pol}}}\xspace}
\newcommand{\Aclpol}{\ensuremath{A_{\text{cl,pol}}}\xspace}
\newcommand{\intersection}{\ensuremath{\theta_{\text{int}}}\xspace}
\newcommand{\clarearatio}{\ensuremath{R_{\text{c,pol}} / R_{\text{c}}}\xspace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
